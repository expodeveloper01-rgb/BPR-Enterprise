          ...
          <div className="max-w-md mx-auto text-center space-y-5">
            ...
            {method === "cod" ? (
              <p className="text-muted-foreground text-sm">
                Your Cash on Delivery order has been received. Pay when your
                order arrives.
              </p>
            ) : (
              <p className="text-muted-foreground text-sm">
                ...
                {method === "cod" && (
                  <div className="rounded-xl bg-amber-50 border border-amber-100 px-4 py-3 text-sm text-amber-800">
                    ...
                    <p className="text-amber-700">
                      ...
                      address. Please prepare the exact amount.
                    </p>
                  </div>
                )}
            ...
            <div className="w-full lg:w-80 shrink-0 sticky top-24">
              <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 space-y-4">
                ...
                <Button
                  type="submit"
                  disabled={loading}
                  className="w-full h-11 rounded-xl bg-black text-white hover:bg-black/80 font-semibold flex items-center justify-center gap-2"
                >
                  {loading ? (
                    <>
