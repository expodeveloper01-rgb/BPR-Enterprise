            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full border-b md:border md:bg-white md:rounded-lg border-b-gray-300 md:border-gray-300 px-0 md:px-4 py-2 text-sm text-gray-900 placeholder:text-gray-500 focus:outline-none focus:border-b-pink-500 md:focus:ring-2 md:focus:ring-pink-500 md:focus:border-transparent transition"
                />
                <button
                  type="button"
